...
const packageJsonHead: string[] = [
  '{',
  '  "name": "@thoughtspot/valkyrie-charts",',
  '  "version": "1.0.0",',
];
...
packageJsonHead.push(
  '  "dependencies": {',
  '    "@sentry/core": "8.48.0",',
  '    "@viz/valkyrie": "0.2.19-rc.175",',
  '    "@viz/chartsettings-versions": "6.2.0",',
  '    "@thoughtspot/ts-chart-sdk": "2.14.3",',
  '    "dompurify": "^3.3.2"',
  '  }',
  '}',
);
...
const diffLines: string[] = [
  ...fileDiff(
    'js/ts-packages/ts-chart-app/src/utils/chart-settings/custom-visual-props.ts',
    chartSettingsHead,
    '  }',
    [
      '   }',
  ...
  ...fileDiff(
    'js/ts-packages/valkyrie-charts/package.json',
    packageJsonHead,
    '    "@sentry/core": "8.48.0",',
    [
      '     "@sentry/core": "8.48.0",',
  ...
  'diff --git a/js/ts-packages/valkyrie-charts/playwright/helpers/chartsettings-structure.ts b/js/ts-packages/valkyrie-charts/playwright/helpers/chartsettings-structure.ts',
  'new file mode 100644',
  '--- /dev/null',
  '+++ b/js/ts-packages/valkyrie-charts/playwright/helpers/chartsettings-structure.ts',
  '@@ -0,0 +1,6 @@',
  '+/**',
  ...
  '+}',
  'diff --git a/js/ts-packages/legacy/old-helper.ts b/js/ts-packages/legacy/old-helper.ts',
  'deleted file mode 100644',
  '--- a/js/ts-packages/legacy/old-helper.ts',
  '+++ /dev/null',
  '@@ -1,3 +0,0 @@',
...
const headFiles: Record<string, string> = {
  'js/ts-packages/ts-chart-app/src/utils/chart-settings/custom-visual-props.ts': `${chartSettingsHead.join('\n')}\n`,
  'js/ts-packages/valkyrie-charts/package.json': `${packageJsonHead.join('\n')}\n`,
};
